...
from selenium.webdriver.support.ui import Select # we need this package to interact with UI

from Browser_Automation_with_Selenium.locators.quotes_page_locators import QuotesPageLocators
from Browser_Automation_with_Selenium.parsers.quote import QuoteParser
...
class QuotesPage:
    ...
    def quotes(self):
        return [
            QuoteParser(e)
            for e in self.browser.find_elements( # elements
